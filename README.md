...
**AI agent brief and reference tooling for building Minecraft servers with Docker** — Paper, modpacks (CurseForge / Modrinth), Velocity proxy, Bedrock, and more. Written in Japanese.
...
| ファイル | 内容 |
|----------|------|
| [docs/minecraft-server-agent-brief.md](docs/minecraft-server-agent-brief.md) | 詳細指示書（1700行超） |
| [AGENTS.md](AGENTS.md) | エージェント向け最短入口 |
...
```text
docs/minecraft-server-agent-brief.md を読んで、Minecraft サーバーを構築してください。
```

または [AGENTS.md](AGENTS.md) を Cursor Rules / プロジェクトルールにリンクしてください。
...
docs/minecraft-server-agent-brief.md に従って構築して。
```
